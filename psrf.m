function  R = psrf(varargin)    %[R,neff,V,W,B] = psrf(varargin)
...
elseif nargin==0
  ...
  I = zeros([size(varargin{1}) nargin]);
  for i=1:nargin
    I(:,:,i) = varargin{i};
  end
end
